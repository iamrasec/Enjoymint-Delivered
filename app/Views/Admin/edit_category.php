      ...
      <div class="col-lg-12 mt-lg-0 mt-4">
        <div class="card">
          <div class="card-body">
            ...
            <input type="hidden" name="id" value="<?= $cat_data['id']; ?>">
              <div class="row">
                <div class="col-12 col-md-6 col-xs-12">
                  <label class="form-label">Category Name</label>
                  <div class="input-group input-group-dynamic">
                    <input type="text" class="form-control" name="cat_name" value="<?= $cat_data['name']; ?>" id="cat_name" required onfocus="focused(this)" onfocusout="defocused(this)">
                  </div>
                </div>
                <div class="col-12 col-md-6 col-xs-12">
                  <div class="row">
                      ...
                      <div class="col-8 col-md-8 col-xs-8 mb-3 ps-1">
                        <div class="input-group input-group-dynamic">
                          <input type="text" id="cat_url" class="form-control w-100 border px-2" name="cat_url" value="<?= $cat_data['url']; ?>" required onfocus="focused(this)" onfocusout="defocused(this)">
                        </div>
                      </div>
                    </div>
                </div>
