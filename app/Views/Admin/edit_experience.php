            ...
            <form role="form" id="add_experience_form" method="post" action="<?php echo $submit_url; ?>" >
              <div class="row">
                <div class="col-12 col-md-6 col-xs-12">
                  ...
                  <?php foreach ($experience as $exps): ?>  
                  <div class="input-group input-group-dynamic">
                  <input type="text" class="form-control" name="exp_id" value="<?= $exps->id ?>" id="exp_id" hidden>
                    <input type="text" class="form-control" name="exp_name" value="<?= $exps->name ?>" id="exp_name" required onfocus="focused(this)" onfocusout="defocused(this)">
                  </div>
                </div>
                <div class="col-12 col-md-6 col-xs-12">
                  <div class="row">
                      <label class="form-label">Experience URL</label>
                      ...
                      <div class="col-8 col-md-8 col-xs-8 mb-3 ps-1">
                        <div class="input-group input-group-dynamic">
                          <input type="text" id="exp_url" class="form-control w-100 border px-2" name="exp_url" required onfocus="focused(this)" onfocusout="defocused(this)" value="<?= $exps->url ?>">
                        </div>
                      </div>
                    </div>
                    <?php endforeach; ?>
