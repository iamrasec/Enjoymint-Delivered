              ...
              <div class="row">
                <div class="col-12 col-md-6 col-xs-12">
                  ...
                  <div class="input-group input-group-dynamic">
                    <input type="text" class="form-control" name="exp_name" value="" id="exp_name" required onfocus="focused(this)" onfocusout="defocused(this)">
                  </div>
                </div>
                <div class="col-12 col-md-6 col-xs-12">
                  <div class="row">
                      ...
                      <div class="col-8 col-md-8 col-xs-8 mb-3 ps-1">
                        <div class="input-group input-group-dynamic">
                          <input type="text" id="exp_url" class="form-control w-100 border px-2" name="exp_url" required onfocus="focused(this)" onfocusout="defocused(this)">
                        </div>
                      </div>
                    </div>
                </div>
...
<script src="<?php echo base_url(); ?>/assets/js/add_experience.js"></script>
<?php $this->endSection() ?>