    ...
    $.ajax({
      ...
      success: function(json) {
        ...
        if(json.success == true) {
          ...
          // let new_product = '<tr class="pid-'+json.data.id+' border"><td><div class="row product-wrap d-flex py-3">';
          // new_product += '<div class="col-12 col-md-2 col-xs-12 product-img"><img src="'+ baseUrl +'/products/images/'+ json.data.images[0].filename +'" style="width: 100px;"></div>';
          // new_product += '<div class="col-12 col-md-8 col-xs-12 product-details"><h6 class="product-title"><a href="'+ baseUrl +'/products/'+ json.data.url +'">'+ json.data.name +'</a></h6></div>';
          // new_product += '<div class="text-sm mb-3"></div>';
          // new_product += '</div></td></tr>';

          // $("#cart_products tbody").append('<tr><td>test</td></tr>');
