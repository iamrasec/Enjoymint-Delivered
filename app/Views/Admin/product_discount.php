  ...
  <div class="container-fluid py-4">
    <div class="row">
      ...
      <div class="col-lg-6 text-right d-flex flex-column justify-content-center">
        <a class="btn bg-gradient-primary mb-0 ms-lg-auto me-lg-0 me-auto mt-lg-0 mt-2" href="<?php echo base_url('/admin/experience/add_experience'); ?>">Add Experience</a>
      </div>
    </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="table-responsive">
              <table id="discount-table" class="table align-items-center mb-0">
              <thead>
                  <tr>
