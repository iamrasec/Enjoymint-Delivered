    ...
    <div class="modal-content">
      <div class="modal-body d-flex justify-content-center align-content-center w-100">
        <div class="row d-flex justify-content-center align-content-center align-self-center w-100">
          <div class="col-4 col-sm-12 col-lg-4 age-check-container d-flex align-items-center px-5 py-5 w-100">
            <div class="row ">
              ...
              <select name="month" class="form-control w-100 border px-2" id="verify-month">
              ...
              <div class="col-xs-4 col-sm-4 mobile-margin-bottom">
              <select name="day" class="form-control w-100 border px-2" id="verify-day">
              ...
              <select name="Year" class="form-control w-100 border px-2" id="verify-year">
