  ...
  <div class="modal-dialog modal-dialog-centered modal-fullscreen" role="document">
    <div class="modal-content">
      <div class="modal-body d-flex justify-content-center align-content-center w-100">
        <div class="row d-flex justify-content-center align-content-center align-self-center w-auto">
          <div class="col-4 col-sm-12 col-lg-4 age-check-container d-flex align-items-center px-5 py-5 w-auto">
            <div class="row ">
              ...
              <div class="col-xs-6 col-sm-6 mobile-margin-bottom">
                    <div class="form-check form-check-info text-left form-control w-auto border px-2">
