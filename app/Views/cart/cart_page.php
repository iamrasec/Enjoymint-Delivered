                              ...
                              <?php if (in_array($product['pid'], $discount_id)){ ?>
                                <?php for($x = 0; $x<count($discount_data); $x++){
                                  if($discount_data[$x]['id'] === $product['pid']){
                                    ?>
                                   <strong class="total-price-display">Discount $<?= $discount_data[$x]['discounted_price'] * $product['qty']; ?></strong><br>
                                   <strong class="total-price-display">Total Discount $<?= $discount_data[$x]['total_cost'] * $product['qty']; ?></strong><br>
                                  ...
                                  <strong class="total-price-display">Original price $<?= number_format($product['product_data']->price * $product['qty'], 2, '.', ','); ?></strong>
                                <?php
                                  }
                                } ?>
