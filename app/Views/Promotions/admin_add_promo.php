            ...
            <div class="card-body">
              ...
              <div class="row mt-4">
                <div class="col-4 col-md-4 col-xs-6 mb-3">
                  ...
                  <div class="input-group input-group-dynamic">
                    <select name="promo_type" id="promo_type" class="form-control w-100 border px-2">
                ...
                <div class="col-2 col-md-2 col-xs-6 mb-3">
                  ...
                  <div class="input-group input-group-dynamic">
                    <input type="number" id="discount_val" name="discount_val" placeholder="0.00" min="0.00" value="0.00" step="0.01">
                  </div>
                </div>
              ...
              <div class="row mt-4">
                <div class="col-12 col-md-12 col-xs-12 mb-3">
                  ...
                  <div class="input-group input-group-dynamic">
                    <input type="number" id="max_prod_discounted" name="max_prod_discounted" placeholder="0" min="0" value="0" step="1">
                  </div>
                </div>
              </div>
              ...
              <!-- <pre><?php print_r($all_categories); ?></pre> -->
