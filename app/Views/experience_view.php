        ...
        <?php for($i = 0; $i < count($products); $i++): ?>
          <div class="col-lg-3 col-sm-6 pt-4 pb-4 reveal-fadein zoom">
            <div class="card product-featured">
              <div class="img-wrap">
                <?php if(isset($products[$i]['images'][0])): ?>
                <a href="<?= base_url('products/'. $products[$i]['url']); ?>"><img class="prod_image" src="<?= base_url('products/images/'.$products[$i]['images'][0]->filename); ?>" /></a>
                <?php else: ?>
                <a href="<?= base_url('products/'. $products[$i]['url']); ?>"><img class="prod_image" src="" /></a>
                <?php endif; ?>
              </div>
